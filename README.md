...
This repository contains a sample of extending [Okta](https://www.okta.com/) authentication using [the redirect model in a Python Flask app](https://developer.okta.com/docs/guides/sign-into-web-app-redirect/python/main/) to protect the API. 
